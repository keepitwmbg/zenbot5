...
let PROPERTY_RANDOM_CHANCE = 0.3; // Chance of a Mutation to spawn a new species -- Try and prevent some stagnation
...
let range = function (v, step, stepSize) {
...
let mutation = function (oldPhenotype, strategy) {
...
let crossover = function (phenotypeA, phenotypeB, strategy) {
  var p1 = {};
  var p2 = {};
...
let fitness = function (phenotype) {
...
let competition = function (phenotypeA, phenotypeB) {
...
let RangeFactor = function (min, max, factor) {
  var r = {
    type: 'intfactor',
    min: min,
    max: max,
...
let RangeFloat = function (min, max) {
  var r = {
    type: 'float',
    min: min,
    max: max,
...
let RangePeriod = function (min, max, period_length) {
  var r = {
    type: 'period_length',
    min: min,
    max: max,
...
let ListOption = function (options) {
  var r = {
    type: 'listOption',
    options: options,
  };
...
export default { create, range, mutation, crossover, fitness, competition, Range, Range0, RangeFactor, RangeFloat, RangePeriod, RangeMaType, ListOption };
